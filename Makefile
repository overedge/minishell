...
#*   Updated: 2016/03/16 18:59:58 by nahmed-m         ###   ########.fr       *#
#                                                                              #
# **************************************************************************** #
...
clean :
	...
	@rm -rf libft.a
	@make clean -C libft/
	@echo "\033[1;34m --minishell-- :\033[m \033[1;32m DELETE OBJ FILES !\033[m"

fclean : clean
	@rm -rf $(NAME)
	@make fclean -C libft/
	@echo "\033[1;34m --minishell-- :\033[m \033[1;32m DELETE minishell !\033[m"
